if (typeof GLOBAL_CONFIG.friends_vue_info !== 'undefined') {
    var UserConfig = {
        private_api_url: GLOBAL_CONFIG.friends_vue_info.apiurl,
        page_turning_number: GLOBAL_CONFIG.friends_vue_info.page_turning_number,
        error_img: GLOBAL_CONFIG.friends_vue_info.error_img
    };
}
function initialize_fc_lite() {
    ...
    randomArticleContainer.style.height='130px';
    ...
    function processArticles(data) {
        ...
        //     <div>订阅:${stats.friends_num}   活跃:${stats.active_num}   总文章数:${stats.article_num}  更新时间:${stats.last_updated_time}<br></div>
        //     <div>更新时间:${stats.last_updated_time}</div>
        // `;
        statsContainer.innerHTML = `
            <div>订阅:${stats.friends_num}   活跃:${stats.active_num}   总文章数:${stats.article_num}   更新时间:${stats.last_updated_time} </div>
        `;
