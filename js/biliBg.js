...
if (biliBannerIndex === 0) {
  ...
  $biliBannerParentsEl.insertAdjacentHTML(
    ...
    `
      ...
      <link rel="stylesheet", href="https://npm.elemecdn.com/acrylic-static@1.0.0/biliBg/autumn/autumn.css" />
    `
  );
  ...
  $biliBannerParentsEl.insertAdjacentHTML(
    ...
    `
      ...
      <link rel="stylesheet", href="https://npm.elemecdn.com/acrylic-static@1.0.0/biliBg/spring/spring.css" />
    `
  );
  ...
  $biliBannerParentsEl.insertAdjacentHTML(
    ...
    `
      ...
      <link rel="stylesheet", href="https://npm.elemecdn.com/acrylic-static@1.0.0/biliBg/winter/winter.css" />
    `
  );
